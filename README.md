...
disclaimer: The code used in the linear expansion model is based on code from supervisor Thomas Søndergaard, used in his book *Green's Function Integral Equation Methods in Nano-optics*.
  1. Ensure that files nrau.m, nrag.m, niau.m and niag.m are installed and visible in the MATLAB folder.
